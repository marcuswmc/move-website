...
// `width`/`height` são os do arquivo: o LogoLoop dimensiona cada logo pela proporção
// para que todos ocupem a mesma área óptica.
export type Partner = { name: string; src: string; href: string; width?: number | null; height?: number | null };

export function PartnerLogoLoop({ partners }: { partners: Partner[] }) {
  return (
    <section className="relative isolate overflow-hidden bg-move-purple px-4 py-24 text-white md:px-14 md:py-32">
        ...
        <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            ...
            <h2 className="max-w-3xl font-sans text-display-3 font-bold leading-[1.02] tracking-[-0.03em] text-white text-balance">
              Em parceria com quem <span className="text-move-yellow">transforma</span>
            </h2>
          </div>
